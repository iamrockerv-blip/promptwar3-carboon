...
export default function AICoach() {
  ...
  return (
    <div id="ai-coach" className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                ...
                <output className="flex justify-start">
                  <div className="bg-neutral-900/60 text-white rounded-2xl rounded-tl-none p-4 border border-white/5">
                    ...
                    <div className="flex gap-1.5 items-center py-1" aria-hidden="true">
                      <span
                        className="w-2 h-2 rounded-full bg-indigo-400 animate-smooth-bounce"
          ...
          <div className="lg:col-span-4 flex flex-col justify-between p-5 rounded-2xl bg-neutral-950/50 border border-white/5">
            ...
            <div className="mt-6 p-4 rounded-xl bg-indigo-950/30 border border-indigo-500/15 text-[11px] text-indigo-200 leading-relaxed font-sans">
              💡 <span className="font-semibold text-white">Pro Tip:</span> Ask about specific
              alternatives in your area, or ask how your simulator toggles can save you money.
            </div>
          </div>
        </div>
      </div>
