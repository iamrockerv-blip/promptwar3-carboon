...
import { Cpu, BookOpen, Scale, CheckCircle2, ArrowRight, Sparkles, Lock } from 'lucide-react';

const STEPS = [
  {
    num: '01',
    title: 'Baseline Quiz',
    desc: '5 high-impact questions covering diet, travel, and energy.'
  },
  {
    num: '02',
    title: 'Aura Identity',
    desc: 'Your Carbon Aura rating (Green to Crimson) based on climate targets.'
  },
  {
    num: '03',
    title: 'Habit Sandbox',
    desc: 'Toggle commuting, diet, and flights. See simulated impacts instantly.'
  },
  {
    num: '04',
    title: 'AI Carbon Coach',
    desc: 'Chat to get custom action plans and localized suggestions.'
  }
];
    ...
    <div className="w-full flex flex-col items-center bg-mesh">
      ...
      <div className="w-full max-w-5xl px-6 pt-16 pb-12 flex flex-col items-center text-center relative">
        ...
        <div className="max-w-3xl flex flex-col gap-6 items-center z-10">
          ...
          >
            Discover your environmental identity, simulate habit shifts in a real-time sandbox, and
            optimize your path to a greener future.
          </m.p>
      ...
      <section className="w-full max-w-5xl px-6 pb-24 space-y-8">
        <div className="text-left max-w-xl">
          <span className="text-[10px] text-accent-sapphire uppercase tracking-widest font-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-text-secondary leading-relaxed">
                Just as aeronautical engineers use digital twins to run virtual diagnostics on
                physical turbines, Carbon Twin AI maps your real-life actions into an active
                simulation clone. You can run mock habit adjustments, commute toggles, and diet
                changes to forecast environmental offsets safely in a virtual environment.
              </p>
            </div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-text-secondary leading-relaxed">
                Our twin engine uses unit-tested, deterministic calculations backed by UK Defra
                (2024) transport constants, Poore & Nemecek (2018 Science) food lifecycle LCAs, and
                the IEA grid indices.
              </p>
            </div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-text-secondary leading-relaxed">
                Your lifestyle inputs and simulation phases are stored entirely locally using your
                browser&apos;s persistent storage. No remote database, no user accounts, and
                absolutely zero web analytics or tracking.
              </p>
            </div>
            <span className="text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2.5 py-1 rounded-full w-fit">
              100% Client-Side
            </span>
          </m.div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-text-secondary leading-relaxed">
                Carbon Twin&apos;s theme is anchored directly to the 1.5°C Paris Agreement emissions
                boundary. To help visualize limits, users must work to transition their twin below
                the 2.3 tonne annual cap.
              </p>
            </div>
            <span className="text-[10px] font-bold text-amber-400 bg-amber-500/10 px-2.5 py-1 rounded-full w-fit">
              Paris Threshold: 2.3t
            </span>
          </m.div>
          ...
          >
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-bold text-white font-display">
                Narration over Invention
              </h3>
              <p className="text-xs text-text-secondary leading-relaxed">
                AI can hallucinate figures. To prevent this, Carbon Twin uses a hybrid pipeline: a
                deterministic science module calculates exact numbers, and the AI coach is limited
                to narrating and suggesting improvements.
              </p>
            </div>
            <span className="text-[10px] font-bold text-rose-400 bg-rose-500/10 px-2.5 py-1 rounded-full w-fit">
              Hybrid AI Guardrails
            </span>
          </m.div>
        </div>
