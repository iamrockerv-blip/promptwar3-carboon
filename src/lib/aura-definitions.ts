...
const AURA_DEFINITIONS: Record<string, AuraDefinition> = {
  green: {
    ...
    description:
      "Your low carbon footprint is a testament to sustainable choices. You live in harmony with the planet's resource bounds.",
  ...
  emerald: {
    ...
    description:
      'You walk a mindful path, keeping your footprint below the global average. A few small changes can make you a true guardian.',
  ...
  sapphire: {
    ...
    description:
      'Your emissions sit around the global average. You are aware of your impact, and you possess the capability to change the narrative.',
  ...
  amber: {
    ...
    description:
      "Your lifestyle exceeds sustainable limits, placing you at a crossroads. The choices you make now will define your twin's future.",
  ...
  crimson: {
    ...
    description:
      "Your carbon footprint is significantly high, stressing the Earth's ecosystems. This is an urgent call to reshape your daily habits.",
