...
export const DEMO_TWIN: CarbonTwin = {
  ...
  lifeReplay: {
    narrative:
      "Your daily path leaves a moderate but tangible trace. Commuting, dining, and traveling weave together into an annual footprint of 7.2 tonnes. While you are not in the critical crimson zone, your lifestyle still commands resources that outpace our Earth's sustainable thresholds.",
    chapters: [
      {
  ...
  auraExplanation:
    'Your Sapphire Aura reflects a lifestyle near the global crossroads. It represents a state of awareness—you are conscious of your environmental footprint, and you possess the capability and agency to reshape this twin into a greener, lighter self.',
