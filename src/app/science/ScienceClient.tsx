...
const FACTORS = {
    ...
    items: [
      {
        ...
        value: 0.17,
        unit: 'kg CO₂e / km',
        source: 'UK Defra 2024 (Passenger Vehicles average)',
        color: 'bg-red-500'
      },
      {
        label: 'Electric Car',
      ...
      },
      {
        ...
        value: 0.07,
        unit: 'kg CO₂e / km',
        source: 'UK Defra 2024 (National Rail & bus average)',
        color: 'bg-indigo-500'
      },
      {
        label: 'Bike / Walk',
    ...
    items: [
      {
        ...
        value: 6.6,
        unit: 'kg CO₂e / serving',
        source: 'Poore & Nemecek (2018, Science, ruminant LCA)',
        color: 'bg-red-500'
      },
      {
        ...
        value: 1.8,
        unit: 'kg CO₂e / serving',
        source: 'Poore & Nemecek (2018, poultry serving LCA)',
        color: 'bg-orange-500'
      },
      {
        ...
        value: 0.9,
        unit: 'kg CO₂e / serving',
        source: 'Poore & Nemecek (2018, vegetarian serving LCA)',
        color: 'bg-teal-500'
      },
      {
        label: 'Vegan Meal',
        value: 0.7,
        unit: 'kg CO₂e / serving',
        source: 'Poore & Nemecek (2018, vegan serving LCA)',
        color: 'bg-emerald-500'
      }
    ]
  },
  energy: {
    ...
    items: [
      {
        label: 'Grid Electricity & Gas Heating',
        value: 1.0,
        unit: 'intensity factor index',
        source: 'IEA / EPA regional grid averages',
        color: 'bg-amber-500'
      },
      {
        label: 'Green Electricity & Heat Pump',
        value: 0.1,
        unit: 'intensity factor index',
        source: 'Zero-carbon local generation baseline',
        color: 'bg-emerald-500'
      }
    ]
  },
  travel: {
    ...
    items: [
      {
        label: 'Short Flight (< 3h)',
        value: 150,
        unit: 'kg CO₂e / flight',
        source: 'Defra flight emissions averages',
        color: 'bg-yellow-500'
      },
      {
        label: 'Long Flight (> 3h)',
        value: 800,
        unit: 'kg CO₂e / flight',
        source: 'Defra long-haul economy factors',
        color: 'bg-red-500'
      }
    ]
  }
...
const AURAS = [
  {
    ...
    name: 'Green (Optimal)',
    range: '< 2.3 t CO₂e / year',
    target: 'Conforms to global sustainability benchmarks for limiting warming'
  },
  {
    color: 'text-green-400 bg-green-400/10 border-green-400/20',
    name: 'Emerald (Sustainable Average)',
    range: '2.3 - 4.7 t CO₂e / year',
    target: 'Fits below median targets, on track for transition'
  },
  {
    color: 'text-blue-400 bg-blue-400/10 border-blue-400/20',
    name: 'Sapphire (Transition Zone)',
    range: '4.7 - 8.0 t CO₂e / year',
    target: 'Typical regional emission rates, optimization recommended'
  },
  {
    color: 'text-amber-400 bg-amber-400/10 border-amber-400/20',
    name: 'Amber (High Intensity)',
    range: '8.0 - 14.0 t CO₂e / year',
    target: 'Exceeds standard limits, key reduction areas flagged'
  },
  {
    color: 'text-red-400 bg-red-400/10 border-red-400/20',
    name: 'Crimson (Extreme Footprint)',
    range: '> 14.0 t CO₂e / year',
    target: 'Highly resource-intensive profile, immediate shifts required'
  }
];
      ...
      <MotionConfig reducedMotion="user">
        ...
        >
          ...
          <div className="w-full max-w-5xl px-6 py-20 text-center space-y-6 relative z-10">
            ...
            >
              We prioritize scientific clarity. Review the math formulas, emission coefficients, and
              reference databases that power our simulation models.
            </m.p>
          </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold font-display">
                    Reproducible Math Formulas
                  </h2>
                </div>
                <p className="text-text-secondary text-sm sm:text-base leading-relaxed font-sans max-w-3xl">
                  Our computation core is built using static algorithms in TypeScript. There are no
                  AI estimates, guesses, or generative models editing your metrics—language models
                  are restricted to explaining the calculated breakdown.
                </p>
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-text-secondary">
                    Select an environmental sector to examine the intensity factors and data
                    origins:
                  </p>
                  ...
                  <div
                    ...
                    role="tablist"
                    aria-label="Carbon coefficient categories"
                  >
              ...
              >
                ...
                <div className="divide-y divide-white/5 border border-white/5 rounded-2xl overflow-hidden bg-black/25 text-xs">
                  {AURAS.map((a) => (
                    <div
                      key={a.name}
                      className="p-3.5 flex flex-col gap-1.5 hover:bg-white/[0.02] transition-colors"
                    >
                      <div className="flex items-center justify-between gap-2">
                        <span
                          className={`px-2 py-0.5 rounded-lg text-[10px] font-extrabold border ${a.color}`}
                        >
                          {a.name}
                        </span>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="font-sans text-neutral-300 leading-relaxed text-xs">
                  This platform functions strictly as an educational simulator. The calculated
                  values represent estimates of Scope 1 (direct travel emissions) and Scope 2
                  (residential utility usage) footprints based on public datasets. This model is not
                  an official environmental audit and does not track the complex supply chains of
                  physical consumer products, food waste, or micro-waste streams.
                </p>
              </div>
            </m.div>
          </div>
